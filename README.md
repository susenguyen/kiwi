...
- kiwi file + config script from https://build.opensuse.org/package/show/SUSE:Templates:Images:SL-Micro-6.2/SL-Micro
...
```
kiwi-ng --profile=x86-self_install --type=oem system build --description=${DESC:-desc} --target-dir=${TARGET_DIR:-target}
```
